...
public class Ms5ClientService {
	...
	public Ms5ClientService(@Qualifier("restTemplateSsl") RestTemplate restTemplate, CallerDestinationProperties callerDestinationProperties) {
	...
	public String get() {
		DestinationClient destinationClient = callerDestinationProperties
				.getDestinationClient(EnumResourceServer.STS_MS5_SERVICE_REGISTRATION.getKey());
