...
//
//@Component
//public class Ms1ClientServiceSAVE {
//
...
//
//    public Ms1ClientServiceSAVE(@Qualifier("restTemplateSsl") RestTemplate restTemplate, CallerDestinationProperties callerDestinationProperties) {
